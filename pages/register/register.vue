<template>
    <view class="register-container">
        ...
        <checkbox :checked="isAgree" icon-size="15px" :checked-color="primaryColor" @click="changeChecked">
            <view class="sm row">
            	已阅读并同意
            	<navigator @tap.stop="" class="primary" hover-class="none" url="/bundle/pages/server_explan/server_explan?type=0">《服务协议》</navigator>
            	和
            	<navigator @tap.stop="" class="primary" hover-class="none" url="/bundle/pages/server_explan/server_explan?type=1">《隐私协议》</navigator>
            </view>
        </checkbox>
