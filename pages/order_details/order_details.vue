			...
			<view class="main">
				<view class="header">
					<view class="item" v-if="orderDetail.order_status == 0">
						...
						<view class="white sm row" style="line-height: 26rpx;" v-if="cancelTime > 0">支付剩余 <u-count-down separator="zh"
								:timestamp="cancelTime" separator-color="#fff"
								color="#fff" :separator-size="26" :font-size="26" bg-color="transparent"></u-count-down>
							自动关闭</view>
					</view>
				...
				<view v-if="orderDetail.delivery_type == 2" class="receiving-card contain">
					...
					<view class="receiving-content">
						...
						<text class="xs muted mt10">
							<text>营业时间：</text>
							<text>{{ orderDetail.selffetch_shop.business_start_time }} - {{ orderDetail.selffetch_shop.business_end_time }}</text>
						</text>
					</view>
				</view>
				...
				<view v-if="orderDetail.delivery_type == 2" class="contain receive">
					...
					<view class="receive-qr" v-if="showQRSelffetch">
						...
						<view class="mt20 qr-contain" :class="{'qr-contain--die': orderDetail.verification_status}" ref="qr-image">
							<tki-qrcode
							  ref="qrcode"
							  uni="px"
						...
						<view class="mt30 xs black qr-code">提货码：{{ orderDetail.pickup_code }}</view>
					</view>
				...
				<view class="price contain">
					...
					<view class="row-end">
						...
						<view class="primary xl">
							<price-format :first-size="34" :second-size="34" :price="orderDetail.order_amount">
							</price-format>
						</view>
					</view>
				</view>
