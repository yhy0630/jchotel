    ...
    <view class="booking-bar">
      <view class="price-info">
        <view class="price-line">
          ...
          <text class="value">¥{{ formatPrice(roomInfo.list_price) }}</text>
        </view>
        <view class="price-line">
          <text class="label">尊享价</text>
          <text class="value highlight">¥{{ formatPrice(roomInfo.vip_price) }}</text>
        </view>
        <view class="price-line">
          <text class="label">股东价</text>
          <text class="value">¥{{ formatPrice(roomInfo.share_price) }}</text>
        </view>
      </view>
