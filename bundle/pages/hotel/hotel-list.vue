      ...
      <view v-for="item in list" :key="item.hotelCode" class="card" @click="goDetail(item)">
        ...
        <view class="info">
          ...
          <view class="price-row">
            <view class="price-line" :class="{ 'highlight': item.user_price_type === 'list' }">
              <text class="price-label" :class="{ 'highlight-label': item.user_price_type === 'list' }">挂牌价</text>
              <text class="price-value" :class="{ 'highlight-value': item.user_price_type === 'list' }">¥{{ formatPrice(item.list_price) }}起</text>
            </view>
            <view class="price-line vip" :class="{ 'highlight': item.user_price_type === 'vip' }">
              <text class="price-label" :class="{ 'highlight-label': item.user_price_type === 'vip' }">尊享价</text>
              <text class="price-value" :class="{ 'highlight-value': item.user_price_type === 'vip' }">¥{{ formatPrice(item.vip_price) }}起</text>
            </view>
            <view class="price-line share" :class="{ 'highlight': item.user_price_type === 'share' }">
              <text class="price-label" :class="{ 'highlight-label': item.user_price_type === 'share' }">股东价</text>
              <text class="price-value" :class="{ 'highlight-value': item.user_price_type === 'share' }">¥{{ formatPrice(item.share_price) }}起</text>
            </view>
          </view>
        </view>
      </view>
...
.price-line.highlight .price-label {
  color: #F3BC63;
  font-weight: 700;
}
...
.price-line.vip:not(.highlight) .price-label,
.price-line.vip:not(.highlight) .price-value {
  color: #fff;
}
