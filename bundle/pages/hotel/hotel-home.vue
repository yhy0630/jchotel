        ...
        >
          ...
          <view class="hotel-info">
            ...
            <view class="hotel-price">
              <text class="price-item" :class="{ 'highlight': item.user_price_type === 'list' }">挂牌价¥{{ formatPrice(item.list_price) }}起</text>
              <text class="price-item vip" :class="{ 'highlight': item.user_price_type === 'vip' }">尊享价¥{{ formatPrice(item.vip_price) }}起</text>
              <text class="price-item share" :class="{ 'highlight': item.user_price_type === 'share' }">股东价¥{{ formatPrice(item.share_price) }}起</text>
            </view>
          </view>
        </view>
